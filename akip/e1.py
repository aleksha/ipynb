...
for ee in e1s:
    ...
    #
    aa  = " | "
    aa += "{:6.3f}".format(Mean.value()) + " +/- " + "{:6.3f}".format(Mean.error()) + " | "
    aa += "{:6.3f}".format( bMean.value() ) + " +/- " + "{:6.3f}".format(bMean.error()) + " || "
    aa += "{:6.3f}".format(Median) + " | "
    aa += "{:6.3f}".format( bMedian.value() ) + " +/- " + "{:6.3f}".format(bMedian.error()) + " || "
    strs.append( aa )
    x +=1.
#
for aa in strs:
