...
void refit4( int EVENTS = 70000000, int TOYS = 0 ){
 ...
 for(int i=0;i<EVENTS;i++){
   ...
   h->Fill( x );
   h1->Fill( x - 0.000001*(0.04-x)/0.039);
   h2->Fill( x - 0.000002*(0.04-x)/0.039);
   h3->Fill( x - 0.000003*(0.04-x)/0.039);
   h4->Fill( x - 0.000004*(0.04-x)/0.039);
   h5->Fill( x + 0.000001*(0.04-x)/0.039);
   h6->Fill( x + 0.000002*(0.04-x)/0.039);
   h7->Fill( x + 0.000003*(0.04-x)/0.039);
   h8->Fill( x + 0.000004*(0.04-x)/0.039);
 }
